...
urlpatterns = [
    ...
    path('projects/<int:project_id>/electrical/wiring/', ElectricalWiringView.as_view(),name='electrical-wiring-list'),
    path('projects/<int:project_id>/electrical/wiring/<int:wiring_id>/',ElectricalWiringView.as_view(),name='electrical-wiring-detail'),
    ...
    path('projects/<int:project_id>/structural/main/',StructuralMainView.as_view(),name='plumbing-complete-list'),
    path('projects/<int:project_id>/structural/main/<int:main_id>',StructuralMainView.as_view(),name='plumbing-complete-list'),
    path('projects/<int:project_id>/structural/centerline/', StructuralCenterLineView.as_view(), name='structural-centerline'),
    path('projects/<int:project_id>/structural/centerline/<int:centerline_id>/', StructuralCenterLineView.as_view(), name='structural-centerline-detail'),
]
